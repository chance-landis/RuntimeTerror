    ...
    return (
        <div className='createwallet'>
            <div className='wrapper'>
                ...
                Direct your browser to <a href='https://metamask.io'>metamask.io</a> and click the download button on the top right of the screen. From there, install the MetaMask extension for 
                your chosen browser.
                </p>
